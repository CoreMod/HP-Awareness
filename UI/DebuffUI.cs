    ...
    internal class DebuffUI : UIState
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            if (!Main.dedServ && Main.myPlayer == Main.LocalPlayer.whoAmI)
            {
                ...
                spriteBatch.Draw(TextureAssets.Buff[Main.LocalPlayer.GetModPlayer<Modplayer>().DebuffToShow].Value, Position - Main.screenPosition - Offset, Opacity);
            }
        }
    }
}
